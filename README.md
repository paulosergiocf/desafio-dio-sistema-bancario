# Suzano - Python Developer - Desafio: Criando um sistema bancário.

Este repositório foi criado para entrega de desafio de códio da DIO referente ao **Suzano - Python Developer**.

> Como se trata do módulo de funções não usarei orientação a objetos neste desafio.

## Objetivo Geral

Criar um sistema bancário com operações: sacar, depositar, e vizualizar extrato.
